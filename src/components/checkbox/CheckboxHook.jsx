...
const CheckboxHook = ({ control, text, ...props }) => {
  ...
  return (
    <label className="cursor-pointer custom-checkbox">
      <input type="checkbox" className="hidden" {...props} {...field} />
      <div className="flex items-center gap-x-3">
        <div className="flex justify-center items-center transition-all bg-white rounded-md custom-checkbox-square">
          <svg
            width="12"
            height="10"
            viewBox="0 0 12 10"
